      ...
      >
        ...
        <DialogContent dividers>
          <p style={{margin: '0 10px', textAlign: 'center', lineHeight: '20px'}}>
            Try saying: <br />Add expense of Rs. 100 in category Fruits of Personal Account for today... 
          </p>
          {
            segment &&
            <p style={{margin: '10px', padding: '5px',color: 'white', backgroundColor: 'black', fontWeight: 'bold'}}>
        ...
        <DialogActions>
          ...
          <Button onClick={handleSubmit} disabled={state.form.amount <= 0 ? true : false} color="primary">
            Submit
          </Button>
        </DialogActions>
      </Dialog>
