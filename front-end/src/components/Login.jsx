      ...
      <>
        ...
        <div>
          ...
          <div className={styles.container}>
            <SignUpForm
              rotateForm={this.changeForm}
              handleParentCallBack={this.handleCall}
              status={this.state.isLoggedIn}
              btn={this.state.isLoggedIn ? styles.rotatefront : styles.rotateback}
            />
            <SignInForm
              rotateForm={this.changeForm}
              handleParentCallBack={this.handleCall}
              status={this.state.isLoggedIn}
              btn={this.state.isLoggedIn ? styles.rotateback : styles.rotatefront}
            />
          </div>
        </div>
      </>
