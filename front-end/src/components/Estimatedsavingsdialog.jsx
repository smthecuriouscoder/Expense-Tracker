...
import { estimatedSavingsDialog } from "./apiurl.js";
...
class EstimatedSavingsDialog extends Component {
  ...
  handleAlert = () => {
    //for showing the snackbar to restrict entering target savings amount greater than income
    this.setState({
      alertOpen: true,
    });
  };
  ...
  handleSubmit = (e) => {
    ...
    if (
      ...
      filterArrayByType(this.props.income, this.state.form.account).reduce(
        ...
        >
          ...
          <DialogActions>
            ...
            <Button
              ...
              disabled={this.state.form.amount <= 0 ? true : false}
              color='primary'
            >
              Submit
            </Button>
